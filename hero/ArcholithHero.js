(function defineArcholithHero(globalScope) {
    ...
    function renderMarkup(definitions) {
        ...
        return [
            ...
            "</div>",
            "</div>",
            '<span class="archolith-hero__crumb">Apache-2.0 · Self-hosted · Neo4j + MCP</span>',
            ...
            '<a class="cta" href="#mechanism">How menhir works</a>',
            '<a class="cta cta--ghost" href="https://github.com/Archolith/menhir">View source</a>',
            "</div>",
